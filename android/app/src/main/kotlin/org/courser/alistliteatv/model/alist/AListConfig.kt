package org.courser.alistliteatv.model.alist
...
data class AListConfig(
    ...
    val bleveDir: String = "", // /storage/emulated/0/Android/data/org.courser.alistandroid.debug/files/data/bleve
    @SerialName("cdn")
    val cdn: String = "",
//    @SerialName("database")
...
//    val log: Log = Log(),
    ...
    val siteUrl: String = "",
    @SerialName("temp_dir")
    val tempDir: String = "", // /storage/emulated/0/Android/data/org.courser.alistandroid.debug/files/data/temp
    ...
    data class Database(
        @SerialName("db_file")
        val dbFile: String = "", // /storage/emulated/0/Android/data/org.courser.alistandroid.debug/files/data/data.db
        @SerialName("host")
        val host: String = "",
        @SerialName("name")
        val name: String = "",
    ...
    data class Log(
        ...
        @SerialName("name")
        val name: String = "" // /storage/emulated/0/Android/data/org.courser.alistandroid.debug/files/data/log/log.log
    )
