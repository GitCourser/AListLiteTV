...
import org.courser.alistliteatv.utils.AndroidUtils.registerReceiverCompat
import org.courser.alistliteatv.utils.ClipboardUtils
...
class AListService : Service(), AList.Listener {
    companion object {
        ...
        const val ACTION_SHUTDOWN =
            "org.courser.alistandroid.service.AlistService.ACTION_SHUTDOWN"

        const val ACTION_COPY_ADDRESS =
            "org.courser.alistandroid.service.AlistService.ACTION_COPY_ADDRESS"

        const val ACTION_STATUS_CHANGED =
            "org.courser.alistandroid.service.AlistService.ACTION_STATUS_CHANGED"
...
//        val color = org.courser.alistandroid.ui.theme.seed.androidColor
